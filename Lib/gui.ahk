...
AutoUpdate := MainGUI.Add("Checkbox", "x360 y640 w110 c00008b Checked", "Auto update") ;360,110
...
MainGUI.Add("Text", "x735 y640 c00008b w30 Choose1 +Center", "Stage:")

StageDropdown := MainGUI.Add("DropDownList", "x777 y635 c00008b w30 Choose1 +Center", ["1", "2", "3"])
StageDropdown.OnEvent("Change", (*) => SaveStageSetting(StageDropdown.Text))

ActionDropdown := MainGUI.Add("DropDownList", "x500 y635 c00008b w85 Choose1 +Center",  [ "Play here"]) 
ActionDropdown.OnEvent("Change", (*) => SavePlaySetting())

RandomStages := MainGUI.Add("Checkbox", "x600 y640 w130 c00008b Checked", "Random Stages?")
...
MainGUI.Add("Text", "x12 y632 w300 c00008b +BackgroundTrans", "Dodos Magic Hill Macro: " . currentVersion)

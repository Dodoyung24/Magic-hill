...
AutoUpdate := MainGUI.Add("Checkbox", "x360 y640 w110 cffffff Checked", "Auto update") ;360,110
...
MainGUI.Add("Text", "x735 y640 cffffff w30 Choose1 +Center", "Stage:")

StageDropdown := MainGUI.Add("DropDownList", "x777 y635 cffffff w30 Choose1 +Center", ["1", "2", "3"])
StageDropdown.OnEvent("Change", (*) => SaveStageSetting(StageDropdown.Text))

ActionDropdown := MainGUI.Add("DropDownList", "x500 y635 cffffff w85 Choose1 +Center",  ["Find match", "Play here"]) 
ActionDropdown.OnEvent("Change", (*) => SavePlaySetting())

RandomStages := MainGUI.Add("Checkbox", "x600 y640 w130 cffffff Checked", "Random Stages?")

changeRandomStages() {
    global randomizedStages := RandomStages.Value
    toggleText := RandomStages.Value ? "Toggled!" : "Disabled!"
    AddToLog("Randomized Stages " toggleText)
}

RandomStages.OnEvent('Click', (*) => changeRandomStages())
...
MainGUI.Add("Text", "x12 y632 w300 c00008b +BackgroundTrans", "Dodos Magic hill macro - Taxi Macro")
